...
namespace Newtonsoft.Json.Converters
{
	...
	{
		// Token: 0x06000453 RID: 1107 RVA: 0x00011A84 File Offset: 0x0000FC84
		...
		// Token: 0x06000454 RID: 1108 RVA: 0x00011AFC File Offset: 0x0000FCFC
		public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
		{
			...
			{
				if (reader.TokenType != JsonToken.StartConstructor || string.Compare(reader.Value.ToString(), "Date", 4) != 0)
				{
